...
class DBUser(Base):
    ...
    last_login = Column(TIMESTAMP, nullable=False, default=datetime.now(timezone.utc))
    update_date = Column(TIMESTAMP, nullable=False, default=datetime.now(timezone.utc), onupdate=datetime.now(timezone.utc))
